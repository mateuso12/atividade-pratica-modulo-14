...
public class ProjetoController {
	...
	public ResponseEntity<Projeto> findByProjetoDescricao(@PathVariable String projetoDescricao) {
		Projeto projeto = projetoService.findByProjetoDescricao(projetoDescricao);
		if(projeto != null)
			return new ResponseEntity<>(projeto, HttpStatus.OK); 
		else 
			return new ResponseEntity<>(null, HttpStatus.NOT_FOUND);		
